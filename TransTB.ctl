...
'The toolbar
Private moToolbar As ComctlLib.Toolbar
...
Public Property Get Toolbar() As ComctlLib.Toolbar
    Set Toolbar = moToolbar
End Property
Public Property Set Toolbar(NewToolbar As ComctlLib.Toolbar)
    ...
    mhWndToolbarDLL = FindWindowEx(mhWndToolbarOCX, 0, "ToolbarWindow32", vbNullString)
